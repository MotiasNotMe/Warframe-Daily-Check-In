...
WinWaitActive("ahk_class Launcher") ; - Ожидание окна лаунчера

; - Поиск кнопки играть.
Loop {
    if (ImageSearch(&FoundX, &FoundY, 0, 0, A_ScreenWidth, A_ScreenHeight, "*10 Data\ru\play.png")) {
	Click FoundX, FoundY
	Goto SearchReward
     }
     else
...
SearchReward: ; - Поиск наград.
Sleep 2000
WinWaitActive("ahk_class WarframePublicEvolutionGfxD3D11")
Sleep 200
Loop 12 {
    if (ImageSearch(&FoundX1, &FoundY1, 0, 0, A_ScreenWidth, A_ScreenHeight, "*90 Data/ru/rewards.png")) {
	CoordMode "Mouse"
	SendMode "Event"
